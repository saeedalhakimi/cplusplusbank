...
private:
    ...
    static void PrintTransferLogRecordLine(cls_bank_client::stTrnsferLogRecord TransferLogRecord)
    {
...
public:
    ...
    static void ShowTransferLogScreen()
    {
        ...
        vector <cls_bank_client::stTrnsferLogRecord> vTransferLogRecord = cls_bank_client::GetTransfersLogList();
        ...
        if (vTransferLogRecord.size() == 0)
            ...
            for (cls_bank_client::stTrnsferLogRecord Record : vTransferLogRecord)
            {
